...
func (e *Encoder) fileType(v *FileType) (err os.Error){
     
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "c9f291611491ba609173254d6e7a3ed0889da501584a821944a61104ff3b9390d86846e5a498e2135509fa8bb411da054ed55120681d7a18dbdedd0e2ed882b6", uint64(unsafe.Sizeof(*v))); error == nil {
     	
       err = e.string(v.filename)
       if err != nil {
       	  return err
       }
...
func (e *Encoder) fileTypeInternal(v *FileType) (err os.Error){
...
func (d *Decoder) fileType() (v *FileType, error os.Error){
...
func (d *Decoder) fileTypeInternal() (v *FileType, error os.Error){
...
func (e *Encoder) any(a Any) (err os.Error){
     ...
     case FileType:
     	hashByte, err := hex.DecodeString("c9f291611491ba609173254d6e7a3ed0889da501584a821944a61104ff3b9390d86846e5a498e2135509fa8bb411da054ed55120681d7a18dbdedd0e2ed882b6")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("c9f291611491ba609173254d6e7a3ed0889da501584a821944a61104ff3b9390d86846e5a498e2135509fa8bb411da054ed55120681d7a18dbdedd0e2ed882b6")
     	// e.string("c9f291611491ba609173254d6e7a3ed0889da501584a821944a61104ff3b9390d86846e5a498e2135509fa8bb411da054ed55120681d7a18dbdedd0e2ed882b6")
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
     ...
     case bytes.Equal(encodedHash, []byte("c9f291611491ba609173254d6e7a3ed0889da501584a821944a61104ff3b9390d86846e5a498e2135509fa8bb411da054ed55120681d7a18dbdedd0e2ed882b6")):
...
func (t *FileType) IpcWrite(serviceName string, hostname string) (syscall.Fd, syscall.Status) {
	serviceFd, status := goodmiddleman.OpenDirectoryPath("/services/" + serviceName)
	if status != syscall.StatusOk {
		log.Fatalf ("Error calling OpenDirectory /services/%s: %v\n", serviceName, status)
		return 0, status
	...
	netFd, status := goodmiddleman.IpcRepeat(serviceFd, sName, hostname, nil)
	if status != syscall.StatusOk {
		log.Fatalf ("Error calling IpcWriteFileType: %v\n", status)
		return 0, status
	}
	writer := goodmiddleman.NewWriter(netFd)
	goodmiddleman.Close(serviceFd)
...
func (t *FileType) Write(fd syscall.Fd) (syscall.Status) {
...
func (t *FileType) WriteVar(path string) (syscall.Status) {
...
func (t *FileType) Read(fd syscall.Fd) (syscall.Status) {
	d := NewDecoder(goodmiddleman.NewReader(fd))
	value, err := d.FileType()
	if err != nil {
...
func (t *FileType) ReadVar(path string) (syscall.Status) {
	fd, name, status := goodmiddleman.OpenPathLastDirectory(path)
	if status != syscall.StatusOk {
		return status
	}
...
func (t *FileType) CreateDirectory(fd syscall.Fd, name string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0xc9,0xf2,0x91,0x61,0x14,0x91,0xba,0x60,0x91,0x73,0x25,0x4d,0x6e,0x7a,0x3e,0xd0,0x88,0x9d,0xa5,0x01,0x58,0x4a,0x82,0x19,0x44,0xa6,0x11,0x04,0xff,0x3b,0x93,0x90,0xd8,0x68,0x46,0xe5,0xa4,0x98,0xe2,0x13,0x55,0x09,0xfa,0x8b,0xb4,0x11,0xda,0x05,0x4e,0xd5,0x51,0x20,0x68,0x1d,0x7a,0x18,0xdb,0xde,0xdd,0x0e,0x2e,0xd8,0x82,0xb6, }  
       return goodmiddleman.CreateDirectory(fd, name, label, hash)
}

func (t *FileType) CreateDirectoryPath(path string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0xc9,0xf2,0x91,0x61,0x14,0x91,0xba,0x60,0x91,0x73,0x25,0x4d,0x6e,0x7a,0x3e,0xd0,0x88,0x9d,0xa5,0x01,0x58,0x4a,0x82,0x19,0x44,0xa6,0x11,0x04,0xff,0x3b,0x93,0x90,0xd8,0x68,0x46,0xe5,0xa4,0x98,0xe2,0x13,0x55,0x09,0xfa,0x8b,0xb4,0x11,0xda,0x05,0x4e,0xd5,0x51,0x20,0x68,0x1d,0x7a,0x18,0xdb,0xde,0xdd,0x0e,0x2e,0xd8,0x82,0xb6, }
